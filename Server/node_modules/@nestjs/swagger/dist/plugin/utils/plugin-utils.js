...
function replaceImportPath(typeReference, fileName, options, compilerOptionsPaths) {
    ...
    try {
        ...
        for (const [key, value] of Object.entries(compilerOptionsPaths)) {
            ...
            if (importPath.includes(keyToMatch)) {
                const newImportPath = path_1.posix.join(from, importPath.replace(keyToMatch, value[0].replace('*', '')));
